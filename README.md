# 🎭 Node-RED Playwright Web Surfing v0.2.0

**Мощная система веб-серфинга на JavaScript для Node-RED**
...
// Смена User-Agent
{ "action": "set_user_agent", "user_agent": "Mozilla/5.0..." }
